...
<script type="application/javascript">
	(function($) {
		...
		$(function() {
			document.title = "<?php esc_attr_e('Firewall Options', 'twodayssss'); ?>" + " \u2039 " + WFAD.basePageName;
	...
	<div class="wf-row">
		<div class="wf-col-xs-12">
			...
			echo wfView::create('options/block-controls', array(
				...
				'backLabelHTML' => sprintf(__('<span class="wf-hidden-xs">Back to </span>%s', 'twodayssss'), $backPage->label()), 
				'restoreDefaultsSection' => wfConfig::OPTIONS_TYPE_FIREWALL,
				'restoreDefaultsMessage' => __('Are you sure you want to restore the default Firewall settings? This will undo any custom changes you have made to the options on this page. If you have manually disabled any rules or added any custom whitelisted URLs, those changes will not be overwritten.', 'twodayssss'),
			))->render();
			?>
		</div>
	</div>

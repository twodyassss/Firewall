...
<html>
	<head>
		<title><?php _e('Your access to this site has been limited', 'twodayssss'); ?></title>
		<style>
			html {
	...
	<body>
		...
		echo $contents;
		?>
		<h4><?php _e('Your access to this site has been limited', 'twodayssss'); ?></h4>
		<p><?php _e('Your access to this service has been temporarily limited. Please try again in a few minutes. (HTTP response code 503)', 'twodayssss'); ?></p>
		<p><?php _e('Reason:', 'twodayssss'); ?> <span style="color: #c10000;"><?php echo $reason; ?></span></p>

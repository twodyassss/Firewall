...
<link rel='stylesheet' id='wordfence-main-style-css'  href='<?php echo wfUtils::getBaseURL() . wfUtils::versionedAsset('css/phpinfo.css'); ?>?ver=<?php echo FIREWALL_VERSION; ?>' type='text/css' media='all' />
<body>
<?php 
ob_start();
phpinfo(INFO_ALL); 

...
<script type="application/javascript">
	(function($) {
		$(function() {
			document.title = "<?php esc_attr_e('Whois Lookup', 'twodayssss'); ?>" + " \u2039 " + WFAD.basePageName;
		});
	})(jQuery);
</script>
...
<div id="wf-tools-whois">
	<div class="wf-section-title">
		<h2><?php _e('Whois Lookup', 'twodayssss') ?></h2>
		<span><?php printf(__('<a href="%s" target="_blank" rel="noopener noreferrer" class="wf-help-link">Learn more<span class="wf-hidden-xs"> about Whois Lookup</span></a>', 'twodayssss'), wfSupportController::esc_supportURL(wfSupportController::ITEM_TOOLS_WHOIS_LOOKUP)); ?>
			<i class="wf-fa wf-fa-external-link" aria-hidden="true"></i></span>
	</div>

	<p><?php _e("The whois service gives you a way to look up who owns an IP address or domain name that is visiting your website or is engaging in malicious activity on your website.", 'twodayssss') ?></p>
	...
	<div>
		...
		<?php if (isset($_GET['wfnetworkblock']) && $_GET['wfnetworkblock']) { ?>
			<h2><?php _e('How to block a network', 'twodayssss') ?></h2>
			<p style="width: 600px;">
			...
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('Whois Lookup', 'twodayssss') ?> <a>${ip}</a></strong>
					</div>
				</div>
			</div>

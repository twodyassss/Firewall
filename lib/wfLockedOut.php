...
<html>
<head>
	<title><?php _e('You are temporarily locked out', 'twodayssss'); ?></title>
	<style>
		html {
...
<body>
	<?php
	$contents = file_get_contents(TF_PATH . '/images/wf-horizontal.svg');
	...
	echo $contents;
	?>
	<h4><?php _e('You are temporarily locked out', 'twodayssss'); ?></h4>
	<p><?php _e('You have been temporarily locked out of this system. This means that you will not be able to log in for a while.', 'twodayssss'); ?></p>
...
<?php endif; ?>
	<hr>
	<ul>
		<li><a href="<?php echo esc_url(site_url()); ?>"><?php _e('Return to the site home page', 'twodayssss'); ?></a></li>
		<li><a href="<?php echo esc_url(admin_url()); ?>"><?php _e('Attempt to return to the admin login page (you may still be locked out)', 'twodayssss'); ?></a></li>
	</ul>
	<hr>
	<?php require(dirname(__FILE__) . '/wfUnlockMsg.php'); ?>
	<p><?php printf(__('Click here to learn more: <a href="%s" target="_blank" rel="noopener noreferrer">Documentation</a>', 'twodayssss'), wfSupportController::esc_supportURL(wfSupportController::ITEM_LOCKED_OUT)); ?></p>
	<p style="color: #999999;margin-top: 2rem;"><em><?php printf(__('Generated by Wordfence at %s', 'twodayssss'), gmdate('D, j M Y G:i:s T', wfWAFUtils::normalizedTime())); ?>.<br><?php _e('Your computer\'s time:', 'twodayssss'); ?> <script type="application/javascript">document.write(new Date().toUTCString());</script>.</em></p>
</body>
</html>
<?php exit(); ?>

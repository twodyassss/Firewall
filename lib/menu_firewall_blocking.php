	...
	<div class="wf-col-xs-12">
		<div class="wf-block wf-always-active">
			...
			<ul class="wf-block-banner">
				<li><?php _e('<strong>Note:</strong> Blocking is disabled when the option "Enable Rate Limiting and Advanced Blocking" is off.', 'twodayssss'); ?></li>
				<li><a href="#" class="wf-btn wf-btn-default" id="wf-blocking-enable"><?php _e('Turn On', 'twodayssss'); ?></a></li>
			</ul>
			<?php endif; ?>
			<?php if (version_compare(phpversion(), '5.4') < 0 && wfConfig::get('isPaid') && wfBlock::hasCountryBlock()): ?>
				<ul class="wf-block-banner">
					<li><?php printf(__('<strong>Note:</strong> The GeoIP database that is required for country blocking has been updated to a new format. This new format requires sites to run PHP 5.4 or newer, and this site is on PHP %s. To ensure country blocking continues functioning, please update PHP.', 'twodayssss'), wfUtils::cleanPHPVersion()); ?></li>
					<li><a href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_SCAN_RESULT_GEOIP_UPDATE); ?>" class="wf-btn wf-btn-default" target="_blank" rel="noopener noreferrer"><?php _e('More Information', 'twodayssss'); ?></a></li>
				</ul>
			<?php endif; ?>
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong id="wf-block-parameters-title" data-new-title="<?php esc_attr_e('Create a Blocking Rule', 'twodayssss'); ?>" data-edit-title="<?php esc_attr_e('Edit Blocking Rule', 'twodayssss'); ?>"><?php _e('Create a Blocking Rule', 'twodayssss'); ?></strong>
					</div>
				</div>
			</div>
			<div class="wf-block-content">
...
<?php if (wfOnboardingController::willShowNewTour(wfOnboardingController::TOUR_BLOCKING)): ?>
	...
	<script type="text/x-jquery-template" id="wfBlockingNewTour1">
		<div>
			<h3><?php _e('Blocking', 'twodayssss'); ?></h3>
			<p><?php _e('Wordfence lets you take control of protecting your site with powerful blocking features. Block traffic based on IP, IP range, hostname, browser, or referrer. Country blocking is available for Premium customers.', 'twodayssss'); ?></p>
	...
	<script type="text/x-jquery-template" id="wfBlockingNewTour2">
		<div>
			<h3><?php _e('Blocking Builder', 'twodayssss'); ?></h3>
			<p><?php _e('All of your blocking rules are in one central location. Choose the Block Type, then enter the details for the rule. Once it has been added, you\'ll see it saved as a rule for your site.', 'twodayssss'); ?></p>
			<div class="wf-pointer-footer">
				<ul class="wf-tour-pagination">
					<li>&bullet;</li>
					<li class="wf-active">&bullet;</li>
	...
	<script type="text/x-jquery-template" id="wfBlockingNewTour3">
		<div>
			<h3><?php _e('Manage Blocking Rules', 'twodayssss'); ?></h3>
			<p><?php _e('Here\'s where you\'ll see all the blocking rules you\'ve created. You can also manage them as well as remove or modify them from this table.', 'twodayssss'); ?></p>
			<div class="wf-pointer-footer">
				<ul class="wf-tour-pagination">
					<li>&bullet;</li>
					<li>&bullet;</li>
...
<?php if (wfOnboardingController::willShowUpgradeTour(wfOnboardingController::TOUR_BLOCKING)): ?>
	...
	<script type="text/x-jquery-template" id="wfBlockingUpgradeTour1">
		<div>
			<h3><?php _e('Blocking Builder', 'twodayssss'); ?></h3>
			<p><?php _e('All of the blocking rules you create are now in one central location. Simply choose the block type and enter the details for the rule you want to create. Premium users have access to advanced country blocking options, found via the <strong>Options</strong> link.', 'twodayssss'); ?></p>
			<div class="wf-pointer-footer">
				<ul class="wf-tour-pagination">
					<li class="wf-active">&bullet;</li>
					<li>&bullet;</li>
	...
	<script type="text/x-jquery-template" id="wfBlockingUpgradeTour2">
		<div>
			<h3><?php _e('Manage Blocking Rules', 'twodayssss'); ?></h3>
			<p><?php _e('All blocking rules you create will show here. You can manage them as well as remove or modify them from the same location.', 'twodayssss'); ?></p>
			<div class="wf-pointer-footer">
				<ul class="wf-tour-pagination">
					<li>&bullet;</li>
					<li class="wf-active">&bullet;</li>

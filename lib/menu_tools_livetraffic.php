...
<script type="application/javascript">
	(function($) {
		$(function() {
			document.title = "<?php esc_attr_e('Live Traffic', 'twodayssss'); ?>" + " \u2039 " + WFAD.basePageName;
...
<div class="wf-section-title">
	<h2><?php _e('Live Traffic', 'twodayssss') ?></h2>
	<span><?php printf(__('<a href="%s" target="_blank" rel="noopener noreferrer" class="wf-help-link">Learn more<span class="wf-hidden-xs"> about Live Traffic</span></a>', 'twodayssss'), wfSupportController::esc_supportURL(wfSupportController::ITEM_TOOLS_LIVE_TRAFFIC)); ?>
...
if (!wfConfig::liveTrafficEnabled($overridden)):
	...
	<div id="wordfenceLiveActivitySecurityOnly"><p>
			<strong><?php _e('Traffic logging mode: Security-related traffic only', 'twodayssss') ?><?php
				if ($overridden) {
					printf(__(' (host setting <a href="%s" class="wfhelp" target="_blank" rel="noopener noreferrer"></a>)', 'twodayssss'), wfSupportController::supportURL(wfSupportController::ITEM_TOOLS_LIVE_TRAFFIC_OPTION_ENABLE));
				} ?>.</strong> <?php _e('Login and firewall activity will appear below.', 'twodayssss') ?></p>
	</div>
<?php else: ?>
	<div id="wordfenceLiveActivityAll"><p>
			<strong><?php _e('Traffic logging mode: All traffic', 'twodayssss') ?><?php
				if ($overridden) {
					printf(__(' (host setting <a href="%s" class="wfhelp" target="_blank" rel="noopener noreferrer"></a>)', 'twodayssss'), wfSupportController::supportURL(wfSupportController::ITEM_TOOLS_LIVE_TRAFFIC_OPTION_ENABLE));
				} ?>.</strong> <?php _e('Regular traffic and security-related traffic will appear below.', 'twodayssss') ?></p>
	</div>
<?php endif; ?>
					...
					<div class="wf-row">
						<div class="<?php echo wfStyle::contentClasses(); ?>">
							<div id="wf-live-traffic-legend">
								<ul>
									<li class="wfHuman"><?php _e('Human', 'twodayssss') ?></li>
									<li class="wfBot"><?php _e('Bot', 'twodayssss') ?></li>
									<li class="wfNotice"><?php _e('Warning', 'twodayssss') ?></li>
									<li class="wfBlocked"><?php _e('Blocked', 'twodayssss') ?></li>
								</ul>
							</div>
										...
										<ul class="wf-live-traffic-controls">
											<li class="wf-live-traffic-filter">
												...
												<label for="wf-live-traffic-filter-show-advanced">
													<?php _e('Show Advanced Filters', 'twodayssss') ?>
												</label>
											</li>
											<li class="wf-live-traffic-show-expanded">
												<ul class="wf-option wf-option-toggled-boolean-switch wf-option-no-spacing" data-option="liveTraf_displayExpandedRecords" data-enabled-value="1" data-disabled-value="0" data-original-value="<?php echo wfConfig::get('liveTraf_displayExpandedRecords') ? 1 : 0; ?>">
													...
													<li class="wf-option-title wf-padding-add-left wf-no-right wf-padding-no-right">
														<?php echo __('Expand All Results', 'twodayssss'); ?>
													</li>
												</ul>
											</li>
										</ul>
														...
														<div class="wf-live-traffic-activity-detail">
															...
															<div class="wf-live-traffic-actions">
																...
																<a class="wf-btn wf-btn-default wf-btn-sm"
																	...
																	<span class="wf-hidden-xs"><?php _e('See recent traffic', 'twodayssss'); ?></span><span class="wf-visible-xs"><?php _e('Recent', 'twodayssss'); ?></span>
																</a>
...
<?php if (wfOnboardingController::willShowNewTour(wfOnboardingController::TOUR_LIVE_TRAFFIC)): ?>
	...
	<script type="text/x-jquery-template" id="wfNewTour1">
		<div>
			<h3><?php _e('Live Traffic', 'twodayssss'); ?></h3>
			<p><?php _e('Live traffic defaults to a summary view of all security-related traffic. Details are viewable by clicking anywhere within the summary record. To switch to the expanded view, click the <strong>Expand All Records</strong> switch.', 'twodayssss'); ?></p>

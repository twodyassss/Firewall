			...
			<div class="wf-dashboard-item-inner">
				<div class="wf-dashboard-item-content">
					<div class="wf-dashboard-item-title">
						<strong><?php _e('Total Attacks Blocked:', 'twodayssss'); ?> </strong><?php _e('Wordfence Network', 'twodayssss'); ?>
					</div>
				...
				<ul class="wf-dashboard-item-list">
					<li>
						<?php if ($d->networkBlock24h === null): ?>
							<div class="wf-dashboard-item-list-text"><p><em><?php _e('Blocked attack counts not available yet.', 'twodayssss'); ?></em></p></div>
						<?php else: ?>
							<div class="wf-dashboard-graph-wrapper">
								<div class="wf-dashboard-toggle-btns">
									<ul class="wf-pagination wf-pagination-sm">
										<li class="wf-active"><a href="#" class="wf-dashboard-graph-attacks" data-grouping="24h"><?php _e('24 Hours', 'twodayssss'); ?></a></li>
										<!-- <li><a href="#" class="wf-dashboard-graph-attacks" data-grouping="7d">7 Days</a></li> -->
										<li><a href="#" class="wf-dashboard-graph-attacks" data-grouping="30d"><?php _e('30 Days', 'twodayssss'); ?></a></li>
									</ul>
								</div>
...
STYLING;
				...
				<p class="wf-dashboard-last-updated"><?php printf(__('Last Updated: %s ago', 'twodayssss'), esc_html(wfUtils::makeTimeAgo(time() - $d->lastGenerated))); ?></p>
			</div>
		</div>
	</div>
</div>
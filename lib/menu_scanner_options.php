...
<script type="application/javascript">
	(function($) {
		$(function() {
			document.title = "<?php esc_attr_e('Scanner Options', 'twodayssss'); ?>" + " \u2039 " + WFAD.basePageName;
	...
	<div class="wf-row">
		<div class="wf-col-xs-12">
			...
			echo wfView::create('options/block-controls', array(
				...
				'restoreDefaultsMessage' => __('Are you sure you want to restore the default Scan settings? This will undo any custom changes you have made to the options on this page.', 'twodayssss'),
			))->render();
			?>
		</div>
	</div>
			...
			<div class="<?php echo wfStyle::contentClasses(); ?>">
				<div id="wf-scan-options" class="wf-fixed-tab-content">
					...
					echo wfView::create('common/section-title', array(
						...
						'helpLabelHTML' => __('Learn more<span class="wf-hidden-xs"> about Scanning</span>', 'twodayssss'),
						'showIcon' => true,
					))->render();
					?>
					<div class="wf-row">

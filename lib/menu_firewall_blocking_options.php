...
<script type="application/javascript">
	(function($) {
		$(function() {
			document.title = "<?php esc_attr_e('Blocking Options', 'twodayssss'); ?>" + " \u2039 " + WFAD.basePageName;
	...
	<div class="wf-row">
		<div class="wf-col-xs-12">
			...
			echo wfView::create('options/block-controls', array(
				...
				'restoreDefaultsMessage' => __('Are you sure you want to restore the default Blocking settings? This will undo any custom changes you have made to the options on this page. Any existing blocks will be preserved.', 'twodayssss'),
			))->render();
			?>
		</div>
	</div>
								...
								<div class="wf-block-header">
									<div class="wf-block-header-content">
										<div class="wf-block-title">
											<strong><?php _e('General', 'twodayssss'); ?></strong>
										</div>
									...
									<ul class="wf-block-list">
										<li>
											...
											echo wfView::create('options/option-toggled', array(
												...
												'title' => __('Display Blocking menu option', 'twodayssss'),
											))->render();
											?>
										</li>
									</ul>

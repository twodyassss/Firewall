		...
		<div class="wf-container-fluid">
								...
								<li>
									<ul class="wf-block-list wf-block-list-horizontal">
										<li class="wf-flex-vertical">
											<h3><?php _e('Free Support', 'twodayssss'); ?></h3>
											<p class="wf-center"><?php _e('Support for free customers is available via our forums page on wordpress.org. The majority of requests <strong>receive an answer within a few days.</strong>', 'twodayssss'); ?></p>
											<p><a href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_FREE); ?>" target="_blank" rel="noopener noreferrer" class="wf-btn wf-btn-default wf-btn-callout-subtle"><?php _e('Go to Support Forums', 'twodayssss'); ?></a></p>
										</li>
										<li class="wf-flex-vertical">
										<?php if (wfConfig::get('isPaid')): ?>
											<h3><?php _e('Premium Support', 'twodayssss'); ?></h3>
											<p class="wf-center"><?php _e('Our senior support engineers <strong>respond to Premium tickets within a few hours</strong> on average and have a direct line to our QA and development teams.', 'twodayssss'); ?></p>
											<p><a href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_PREMIUM); ?>" target="_blank" rel="noopener noreferrer" class="wf-btn wf-btn-primary wf-btn-callout-subtle"><?php _e('Go to Premium Support', 'twodayssss'); ?></a></p>
										<?php else: ?>
											<h3><?php _e('Upgrade Now to Access Premium Support', 'twodayssss'); ?></h3>
											<p class="wf-center"><?php _e('Our senior support engineers <strong>respond to Premium tickets within a few hours</strong> on average and have a direct line to our QA and development teams.', 'twodayssss'); ?></p>
											<p><a href="https://www.wordfence.com/gnl1supportUpgrade/wordfence-signup/" target="_blank" rel="noopener noreferrer" class="wf-btn wf-btn-primary wf-btn-callout-subtle"><?php _e('Upgrade to Premium', 'twodayssss'); ?></a></p>
										<?php endif; ?>
										</li>
									</ul>
								</li>
						...
						<div class="wf-block-header">
							<div class="wf-block-header-content">
								<div class="wf-block-title">
									<strong><?php _e('GDPR Information', 'twodayssss'); ?></strong>
								</div>
							...
							<ul class="wf-block-list">
									...
									<ul class="wf-option wf-option-static">
										<li class="wf-option-title">
											<ul class="wf-flex-vertical wf-flex-align-left">
												<li><?php _e('General Data Protection Regulation', 'twodayssss'); ?> <a href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_GDPR); ?>" target="_blank" rel="noopener noreferrer" class="wf-inline-help"><i class="wf-fa wf-fa-question-circle-o" aria-hidden="true"></i></a></li>
												<li class="wf-option-subtitle"><?php _e('The GDPR is a set of rules that provides more control over EU personal data. Defiant has updated its terms of use, privacy policies, and software, as well as made available a data processing agreement to meet GDPR compliance.', 'twodayssss'); ?></li>
											</ul>
										</li>
									</ul>
								</li>
								<li>
									<ul class="wf-option wf-option-static">
										<li class="wf-option-title">
											<ul class="wf-flex-vertical wf-flex-align-left">
												<li><?php _e('Data Processing Agreement', 'twodayssss'); ?> <a href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_GDPR_DPA); ?>" target="_blank" rel="noopener noreferrer" class="wf-inline-help"><i class="wf-fa wf-fa-question-circle-o" aria-hidden="true"></i></a></li>
												<li class="wf-option-subtitle"><?php printf(__('If you qualify as a data controller under the GDPR and need a data processing agreement, it can be <a href="%s" target="_blank" rel="noopener noreferrer">found here</a>.', 'twodayssss'), wfSupportController::esc_supportURL(wfSupportController::ITEM_GDPR_DPA)); ?></li>
											</ul>
										</li>
									</ul>
								</li>
								<li>
									<ul class="wf-option wf-option-static">
										<li class="wf-option-title">
											<ul class="wf-flex-vertical wf-flex-align-left">
												<li><?php _e('Agreement to New Terms and Privacy Policies', 'twodayssss'); ?></li>
												<li class="wf-option-subtitle"><?php _e('To continue using Defiant products and services including the Wordfence plugin, all customers must review and agree to the updated terms and privacy policies. These changes reflect our commitment to follow data protection best practices and regulations. The Wordfence interface will remain disabled until these terms are agreed to.', 'twodayssss'); ?></li>
											</ul>
										</li>
									</ul>
								</li>
			...
			<div class="wf-row">
				<div class="wf-col-xs-12 wf-col-sm-9 wf-col-sm-half-padding-right wf-add-top">
					<h3 class="wf-no-top"><?php _e('All Documentation', 'twodayssss'); ?></h3>
				</div>
			</div>
			<div class="wf-row">
					...
					<div class="wf-block wf-active">
						<div class="wf-block-content">
							<div class="wf-support-top-block">
								<h4><?php _e('Top Topics and Questions', 'twodayssss'); ?></h4> 
								<ol>
								<?php
					...
					<div class="wf-block wf-active">
						<div class="wf-block-content">
							<div class="wf-support-missing-block">
								<h4><?php _e('Documentation', 'twodayssss'); ?></h4>
								<p><?php _e('Documentation about Wordfence may be found on our website by clicking the button below or by clicking the <i class="wf-fa wf-fa-question-circle-o" aria-hidden="true"></i> links on any of the plugin\'s pages.', 'twodayssss'); ?></p>
								<p class="wf-no-bottom"><a href="<?php echo wfSupportController::esc_supportURL(wfSupportController::ITEM_INDEX); ?>" target="_blank" rel="noopener noreferrer" class="wf-btn wf-btn-default wf-btn-callout-subtle"><?php _e('View Documentation', 'twodayssss'); ?></a></p>
							</div>
						</div>
					</div>
				</div>

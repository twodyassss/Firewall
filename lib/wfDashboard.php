...
class wfDashboard {
	...
	public function __construct() {
		...
		$this->localBlocks[] = array('title' => __('Complex', 'twodayssss'), 'type' => wfActivityReport::BLOCK_TYPE_COMPLEX,
		...
		$this->localBlocks[] = array('title' => __('Brute Force', 'twodayssss'), 'type' => wfActivityReport::BLOCK_TYPE_BRUTE_FORCE,
		...
		$this->localBlocks[] = array('title' => __('Blacklist', 'twodayssss'), 'type' => wfActivityReport::BLOCK_TYPE_BLACKLIST,

	...
	<div class="wf-col-xs-12">
		<div class="wf-block<?php if (!$collapseable) { echo ' wf-always-active'; } else { echo (wfPersistenceController::shared()->isActive($stateKey) ? ' wf-active' : ''); } ?>" data-persistence-key="<?php echo esc_attr($stateKey); ?>">
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('Live Traffic Options', 'twodayssss'); ?></strong>
					</div>
			...
			<div class="wf-block-content wf-clearfix">
				<?php if ($showControls): ?>
				<p>
					<?php _e('These options let you choose which traffic to log and to ignore certain types of visitors, based on their level of access, usernames, IP address, or browser type. If you run a high-traffic website where it is not feasible to see your visitors in real-time, simply change the <strong>Traffic logging mode</strong> to "Security Only."', 'twodayssss') ?>
				</p>
				...
				<div class="wf-row">
					<div class="wf-col-xs-12">
						...
						echo wfView::create('options/block-controls', array(
							...
							'restoreDefaultsMessage' => __('Are you sure you want to restore the default Live Traffic settings? This will undo any custom changes you have made to the options on this page.', 'twodayssss'),
						))->render();
						?>
					</div>
				</div>
				...
				<ul class="wf-block-list">
					<li>
						...
						echo wfView::create('options/option-switch', array(
							...
							'title' => __('Traffic logging mode', 'twodayssss'),
							'states' => array(
								array('value' => '0', 'label' => __('Security Only', 'twodayssss')),
								array('value' => '1', 'label' => __('All Traffic', 'twodayssss')),
							),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title'         => __("Don't log signed-in users with publishing access", 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-text', array(
							...
							'title'          => __('List of comma separated usernames to ignore', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-text', array(
							...
							'title'          => __('List of comma separated IP addresses to ignore', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-text', array(
							...
							'title'          => __('Browser user-agent to ignore', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-text', array(
							...
							'title'          => __('Amount of Live Traffic data to store (number of rows)', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-text', array(
							...
							'title'          => __('Maximum days to keep Live Traffic data (minimum: 1)', 'twodayssss'),
						))->render();
						?>
					</li>
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Display Live Traffic menu option', 'twodayssss'),
						))->render();
						?>
					</li>
					<?php endif; ?>

...
<div class="wf-section-title">
	...
	<div><a href="#" class="wf-toggle-all-sections wf-btn wf-btn-callout-subtle wf-btn-default" data-collapsed-title="<?php esc_attr_e('Expand All', 'twodayssss'); ?>" data-expanded-title="<?php esc_attr_e('Collapse All', 'twodayssss'); ?>" data-expanded="<?php echo wfUtils::truthyToInt($expanded); ?>"></a></div>
</div>
		...
		$(function() {
			$('.wf-toggle-all-sections').on('click', function(e) {
				...
				if ($(this).data('expanded') == 1) {
					...
					WFAD.ajax('FIREWALL_saveDisclosureState', {names: <?php echo json_encode($stateKeys) ?>, state: false}, function() {}, function() {}, true);
					...
					WFAD.ajax('FIREWALL_saveDisclosureState', {names: <?php echo json_encode($stateKeys) ?>, state: true}, function() {}, function() {}, true);

			...
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('Activity Report', 'twodayssss'); ?></strong>
					</div>
				...
				<ul class="wf-block-list">
					<li>
						...
						echo wfView::create('options/option-toggled-select', array(
							...
							'selectOptions' => array(
								array('value' => 'daily', 'label' => __('Once a day', 'twodayssss')),
								array('value' => 'weekly', 'label' => __('Once a week', 'twodayssss')),
								array('value' => 'monthly', 'label' => __('Once a month', 'twodayssss')),
							),
							'selectValue' => wfConfig::get('email_summary_interval'),
							'title' => __('Enable email summary', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-textarea', array(
							...
							'title' => __('List of directories to exclude from recently modified file list', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Enable activity report widget on the WordPress dashboard', 'twodayssss'),
						))->render();
						?>
					</li>
				</ul>

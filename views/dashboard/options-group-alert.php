			...
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('Email Alert Preferences', 'twodayssss'); ?></strong>
					</div>
				...
				<ul class="wf-block-list">
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Email me when Wordfence is automatically updated', 'twodayssss'),
							'subtitle' => __('If you have automatic updates enabled (see above), you\'ll get an email when an update occurs.', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Email me if Wordfence is deactivated', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Email me if the Wordfence Web Application Firewall is turned off', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled-select', array(
							...
							'selectOptions' => array(
								array('value' => wfIssues::SEVERITY_CRITICAL, 'label' => __('Critical', 'twodayssss')),
								array('value' => wfIssues::SEVERITY_HIGH, 'label' => __('High', 'twodayssss')),
								array('value' => wfIssues::SEVERITY_MEDIUM, 'label' => __('Medium', 'twodayssss')),
								array('value' => wfIssues::SEVERITY_LOW, 'label' => __('Low', 'twodayssss')),
							),
							'selectValue' => wfConfig::get('alertOn_severityLevel'),
							'title' => __('Alert me with scan results of this severity level or greater:', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Alert when an IP address is blocked', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Alert when someone is locked out from login', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Alert when someone is blocked from logging in for using a password found in a breach', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Alert when the "lost password" form is used for a valid user', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled-sub', array(
							...
							'title' => __('Alert me when someone with administrator access signs in', 'twodayssss'),
							
							'subOptionName' => 'alertOn_firstAdminLoginOnly',
							'subEnabledValue' => 1,
							'subDisabledValue' => 0,
							'subValue' => wfConfig::get('alertOn_firstAdminLoginOnly') ? 1 : 0,
							'subTitle' => __('Only alert me when that administrator signs in from a new device or location', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled-sub', array(
							...
							'title' => __('Alert me when a non-admin user signs in', 'twodayssss'),
							
							'subOptionName' => 'alertOn_firstNonAdminLoginOnly',
							'subEnabledValue' => 1,
							'subDisabledValue' => 0,
							'subValue' => wfConfig::get('alertOn_firstNonAdminLoginOnly') ? 1 : 0,
							'subTitle' => __('Only alert me when that user signs in from a new device or location', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Alert me when there\'s a large increase in attacks detected on my site', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-text', array(
							...
							'title' => __('Maximum email alerts to send per hour', 'twodayssss'),
							'subtitle' => __('0 means unlimited alerts will be sent.', 'twodayssss'),
						))->render();
						?>
					</li>
				</ul>

		...
		<div class="wf-block<?php if (!$collapseable) { echo ' wf-always-active'; } else { echo (wfPersistenceController::shared()->isActive($stateKey) ? ' wf-active' : ''); } ?>" data-persistence-key="<?php echo esc_attr($stateKey); ?>">
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('General Wordfence Options', 'twodayssss'); ?></strong>
					</div>
			...
			<div class="wf-block-content">
				<ul class="wf-block-list">
					<li>
						<?php
						$subtitle = __('Automatically updates Wordfence to the newest version within 24 hours of a new release.', 'twodayssss');
						if (!wfConfig::get('other_bypassLitespeedNoabort', false) && getenv('noabort') != '1' && stristr($_SERVER['SERVER_SOFTWARE'], 'litespeed') !== false) {
							$subtitle .= '<br><br>';
							$subtitle .= __('<span class="wf-red-dark">Warning:</span> You are running the LiteSpeed web server and Wordfence can\'t determine whether "noabort" is set. Please verify that the environmental variable "noabort" is set for the local site, or the server\'s global External Application Abort is set to "No Abort".', 'twodayssss');
							$subtitle .= '<br>';
							$subtitle .= '<a href="' . wfSupportController::esc_supportURL(wfSupportController::ITEM_DASHBOARD_OPTION_LITESPEED_WARNING) . '" target="_blank" rel="noopener noreferrer">' . __('Please read this article in our FAQ to make an important change that will ensure your site stability during an update.', 'twodayssss') . '</a>';
						}
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Update Wordfence automatically when a new version is released?', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-text', array(
							...
							'title' => __('Where to email alerts', 'twodayssss'),
							'placeholder' => __('Separate multiple addresses with commas', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Hide WordPress version', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Disable Code Execution for Uploads directory', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Pause live updates when window loses focus', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-text', array(
							...
							'title' => __('Update interval in seconds', 'twodayssss'),
							'subtitle' => __('Setting higher will reduce browser traffic but slow scan starts, live traffic &amp; status updates.', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Bypass the LiteSpeed "noabort" check', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Delete Wordfence tables and data on deactivation', 'twodayssss'),
							'subtitle' => __('Note: This does not include Login Security settings and tables. An option to delete those must be selected separately on the Login Security settings page.', 'twodayssss'),

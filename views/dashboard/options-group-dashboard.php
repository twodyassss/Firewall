			...
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('Dashboard Notification Options', 'twodayssss'); ?></strong>
					</div>
				...
				<ul class="wf-block-list">
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Updates Needed (Plugin, Theme, or Core)', 'twodayssss'),
						))->render();
						?>
					</li>
					<?php if (wfConfig::p()): ?>
						<li>
							...
							echo wfView::create('options/option-toggled', array(
								...
								'title' => __('Security Alerts', 'twodayssss'),
								'premium' => true,
							))->render();
							?>
						</li>
						<li>
							...
							echo wfView::create('options/option-toggled', array(
								...
								'title' => __('Promotions', 'twodayssss'),
								'premium' => true,
							))->render();
							?>
						</li>
						<li>
							...
							echo wfView::create('options/option-toggled', array(
								...
								'title' => __('Blog Highlights', 'twodayssss'),
								'premium' => true,
							))->render();
							?>
						</li>
						<li>
							...
							echo wfView::create('options/option-toggled', array(
								...
								'title' => __('Product Updates', 'twodayssss'),
								'premium' => true,
							))->render();
							?>
						</li>
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Scan Status', 'twodayssss'),
						))->render();
						?>
					</li>
					<?php if (!wfConfig::p()): ?>
						<li>
							<ul class="wf-option">
								...
								<li class="wf-flex-vertical wf-flex-align-left">
									<p><?php _e('Dashboard notifications will also be displayed for Security Alerts, Promotions, Blog Highlights, and Product Updates. These notifications can be disabled by upgrading to a premium license.', 'twodayssss'); ?></p>

			...
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('View Customization', 'twodayssss'); ?></strong>
					</div>
				...
				<ul class="wf-block-list">
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Display "All Options" menu item', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Display "Blocking" menu item', 'twodayssss'),
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Display "Live Traffic" menu item', 'twodayssss'),
						))->render();
						?>
					</li>
				</ul>

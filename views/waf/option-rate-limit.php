	...
	<li class="wf-option-content">
		<ul>
			...
			<li class="wf-option-select wf-left-xs wf-padding-add-top-xs-small wf-nowrap">
				...
				<span class="wf-padding-add-left-small wf-padding-add-right-small wf-padding-add-top-xs-small wf-padding-add-bottom-xs-small wf-inline-block-xs"><?php _e('then', 'twodayssss'); ?></span>

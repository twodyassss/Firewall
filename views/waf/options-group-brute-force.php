			...
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('Brute Force Protection', 'twodayssss'); ?></strong>
					</div>
				...
				<ul class="wf-block-list">
					<li>
						...
						echo wfView::create('options/option-switch', array(
							...
							'titleHTML' => '<strong>' . __('Enable brute force protection', 'twodayssss') . '</strong>',
							'subtitle' => __('This option enables all "Brute Force Protection" options, including strong password enforcement and invalid login throttling. You can modify individual options below.', 'twodayssss'),
							'states' => array(
					...
					<li>
						...
						echo wfView::create('options/option-select', array(
							...
							'title' => __('Lock out after how many login failures', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-select', array(
							...
							'title' => __('Lock out after how many forgot password attempts', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-select', array(
							...
							'title' => __('Count failures over what time period', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-select', array(
							...
							'title' => __('Amount of time a user is locked out', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Immediately lock out invalid usernames', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-token', array(
							...
							'tokenValue' => $users,
							'title' => __('Immediately block the IP of users who try to sign in as these usernames', 'twodayssss'),
							'subtitle' => __('Hit enter to add a username', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled-select', array(
							...
							'selectOptions' => array(array('value' => 'admins', 'label' => __('For admins only', 'twodayssss')), array('value' => 'pubs', 'label' => __('For all users with "publish posts" capability', 'twodayssss'))),
							'selectValue' => wfConfig::get('loginSec_breachPasswds'),
							'title' => __('Prevent the use of passwords leaked in data breaches', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-label', array(
							'titleHTML' => '<strong>' . __('Additional Options', 'twodayssss') . '</strong>',
							'noSpacer' => true,
						))->render();
						?>
					</li>
					<li>
						...
						echo wfView::create('options/option-toggled-select', array(
							...
							'selectOptions' => array(array('value' => 'pubs', 'label' => __('Force admins and publishers to use strong passwords (recommended)', 'twodayssss')), array('value' => 'all', 'label' => __('Force all members to use strong passwords', 'twodayssss'))),
							'selectValue' => wfConfig::get('loginSec_strongPasswds'),
							'title' => __('Enforce strong passwords', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Don\'t let WordPress reveal valid users in login errors', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Prevent users registering \'admin\' username if it doesn\'t exist', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Prevent discovery of usernames through \'/?author=N\' scans, the oEmbed API, and the WordPress REST API', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Block IPs who send POST requests with blank User-Agent and Referer', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-textarea', array(
							...
							'title' => __('Custom text shown on block pages', 'twodayssss'),
							'alignTitle' => 'top',
							'subtitleHTML' => __('HTML tags will be stripped prior to output and line breaks will be converted into the appropriate tags.', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Check password strength on profile update', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-toggled', array(
							...
							'title' => __('Participate in the Real-Time Wordfence Security Network', 'twodayssss'),

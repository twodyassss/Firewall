			...
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('Advanced Country Blocking Options', 'twodayssss'); ?></strong>
					</div>
					...
					<ul class="wf-block-list">
						<li>
							...
							echo wfView::create('options/option-select', array(
								...
								'title' => __('What to do when we block someone', 'twodayssss'),
						...
						<li>
							...
							echo wfView::create('options/option-text', array(
								...
								'title' => __('URL to redirect blocked users to', 'twodayssss'),
								'placeholder' => __('Enter a full URL (e.g., http://example.com/blocked/)', 'twodayssss'),
						...
						<li>
							...
							echo wfView::create('options/option-toggled', array(
								...
								'title' => __('Block countries even if they are logged in', 'twodayssss'),

	...
	<div class="wf-modal" id="wf-country-selector">
		<div class="wf-modal-header">
			<div class="wf-modal-header-content">
				<div class="wf-modal-title">
					<?php _e('Select Countries to Block from List', 'twodayssss'); ?>
				</div>
			</div>
			<div class="wf-modal-header-action">
				<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle wf-countries-shortcut" id="wf-country-selector-block-all" data-shortcut="select"><?php _e('Block All', 'twodayssss'); ?></a>&nbsp;&nbsp;<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle wf-countries-shortcut" id="wf-country-selector-unblock-all" data-shortcut="deselect"><?php _e('Unblock All', 'twodayssss'); ?></a>
			</div>
		</div>
		...
		<div class="wf-modal-footer">
			<ul class="wf-flex-horizontal wf-flex-full-width">
				...
				<li class="wf-right"><a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" id="wf-country-selector-cancel"><?php _e('Back', 'twodayssss'); ?></a>&nbsp;&nbsp;<a href="#" class="wf-btn wf-btn-primary wf-btn-callout-subtle" id="wf-country-selector-confirm"><?php _e('Save', 'twodayssss'); ?></a></li>
			</ul>
		</div>
	</div>
</script>

			...
			<div class="wf-flex-row">
				...
				<div class="wf-flex-row-1">
					<?php if (empty($statusList)): ?>
						...
						<p><a target="_blank" rel="noopener noreferrer" href="<?php echo esc_url($helpLink) ?>"><?php _e('How does Wordfence determine this?', 'twodayssss') ?></a></p>
					<?php else: ?>
						<h4><?php _e('How do I get to 100%?', 'twodayssss') ?></h4>
						<ul>

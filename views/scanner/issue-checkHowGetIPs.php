...
echo wfView::create('scanner/issue-base', array(
	...
	'displayType' => __('IP Detection', 'twodayssss'),
	...
	'detailControls' => array(
		'<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="WFAD.useRecommendedHowGetIPs(\'${id}\'); return false;">' . __('Use Recommended Value', 'twodayssss') . '</a>',

...
echo wfView::create('scanner/issue-base', array(
	...
	'displayType' => __('Directory Listing Enabled', 'twodayssss'),
	...
	'detailControls' => array(
		...
		'{{if data.canDelete}}<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="WFAD.deleteFile(\'${id}\'); return false;">' . __('Delete File', 'twodayssss') . '</a>{{/if}}',
		'<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="WFAD.updateIssueStatus(\'${id}\', \'delete\'); return false;">' . __('Mark as Fixed', 'twodayssss') . '</a>',
	),

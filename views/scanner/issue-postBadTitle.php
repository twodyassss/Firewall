...
echo wfView::create('scanner/issue-base', array(
	...
	'displayType' => __('Post', 'twodayssss'),
	...
	'summaryControls' => array(wfView::create('scanner/issue-control-edit-post'), wfView::create('scanner/issue-control-ignore', array('ignoreP' => __('Always Ignore', 'twodayssss'), 'ignoreC' => __('Ignore Only this Title', 'twodayssss'))), wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
		__('Title', 'twodayssss') => '<strong class="wfWarn">${data.postTitle}</strong>',
		__('Posted on', 'twodayssss') => '${data.postDate}',
		null,
	...
	'textOutputDetailPairs' => array(
		__('Title', 'twodayssss') => '$data.postTitle',
		__('Posted on', 'twodayssss') => '$data.postDate',
		null,

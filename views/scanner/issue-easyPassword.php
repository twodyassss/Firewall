...
echo wfView::create('scanner/issue-base', array(
	...
	'displayType' => __('Insecure Password', 'twodayssss'),
	...
	'summaryControls' => array(wfView::create('scanner/issue-control-edit-user'), wfView::create('scanner/issue-control-ignore', array('ignoreP' => __('Ignore All for User', 'twodayssss'), 'ignoreC' => __('Ignore Only this Password', 'twodayssss'))), wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
		__('Login Name', 'twodayssss') => '${data.user_login}',
		__('User Email', 'twodayssss') => '${data.user_email}',
		__('Full Name', 'twodayssss') => '${data.first_name} ${data.last_name}',
		null,

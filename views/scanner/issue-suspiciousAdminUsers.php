...
echo wfView::create('scanner/issue-base', array(
	...
	'displayType' => __('Unknown Administrator', 'twodayssss'),
	...
	'summaryControls' => array(wfView::create('scanner/issue-control-ignore', array('ignoreP' => __('Ignore', 'twodayssss'))), wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(
		__('Details', 'twodayssss') => '{{html longMsg}}',
	),
	'detailControls' => array(
		'<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="WFAD.deleteAdminUser(\'${id}\'); return false;">' . __('Delete User', 'twodayssss') . '</a>',
		'<a href="#" class="wf-btn wf-btn-default wf-btn-callout-subtle" onclick="WFAD.revokeAdminUser(\'${id}\'); return false;">' . __('Revoke Capabilities', 'twodayssss') . '</a>',

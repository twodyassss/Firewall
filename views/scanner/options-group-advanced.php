			...
			<div class="wf-block-header">
				<div class="wf-block-header-content">
					<div class="wf-block-title">
						<strong><?php _e('Advanced Scan Options', 'twodayssss'); ?></strong>
					</div>
				...
				<ul class="wf-block-list">
					<li>
						...
						echo wfView::create('options/option-textarea', array(
							...
							'title' => __('Exclude files from scan that match these wildcard patterns (one per line)', 'twodayssss'),
					...
					<li>
						...
						echo wfView::create('options/option-textarea', array(
							...
							'title' => __('Additional scan signatures (one per line)', 'twodayssss'),

...
echo wfView::create('scanner/issue-base', array(
	...
	'displayType' => __('Unknown Core File', 'twodayssss'),
	...
	'summaryControls' => array(wfView::create('scanner/issue-control-ignore', array('ignoreP' => __('Always Ignore Version', 'twodayssss'), 'ignoreC' => __('Ignore Until Version Changes', 'twodayssss'))), wfView::create('scanner/issue-control-show-details')),
	'detailPairs' => array(__('Details', 'twodayssss') => '{{html longMsg}}'),

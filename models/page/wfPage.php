...
class wfPage {
	...
	public function label() {
		switch ($this->identifier) {
			case self::PAGE_DASHBOARD:
				return __('Dashboard', 'twodayssss');
			case self::PAGE_DASHBOARD_OPTIONS:
				return __('Global Options', 'twodayssss');
			case self::PAGE_FIREWALL:
				return __('Firewall', 'twodayssss');
			case self::PAGE_FIREWALL_OPTIONS:
				return __('Firewall Options', 'twodayssss');
			case self::PAGE_BLOCKING:
				return __('Blocking', 'twodayssss');
			case self::PAGE_BLOCKING_OPTIONS:
				return __('Blocking Options', 'twodayssss');
			case self::PAGE_SCAN:
				return __('Scan', 'twodayssss');
			case self::PAGE_SCAN_OPTIONS:
				return __('Scan Options', 'twodayssss');
			case self::PAGE_TOOLS_2FA:
				return __('Two-Factor Authentication', 'twodayssss');
			case self::PAGE_TOOLS_LIVE_TRAFFIC:
				return __('Live Traffic', 'twodayssss');
			case self::PAGE_TOOLS_IMPORT_EXPORT:
				return __('Import/Export Options', 'twodayssss');
			case self::PAGE_TOOLS_WHOIS:
				return __('Whois Lookup', 'twodayssss');
			case self::PAGE_TOOLS_DIAGNOSTICS:
				return __('Diagnostics', 'twodayssss');
			case self::PAGE_SUPPORT:
				return __('Support', 'twodayssss');
		}

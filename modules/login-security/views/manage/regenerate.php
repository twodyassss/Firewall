...
<script type="text/x-jquery-template" id="wfls-tmpl-recovery-prompt">
	...
	echo \WordfenceLS\Model_View::create('common/modal-prompt', array(
		'title' => __('Generate New Recovery Codes', 'twodayssss'),
		'message' => __('Are you sure you want to generate new recovery codes? Any remaining unused codes will be disabled.'),
		'primaryButton' => array('id' => 'wfls-recovery-prompt-cancel', 'label' => __('Cancel', 'twodayssss'), 'link' => '#'),
		'secondaryButtons' => array(array('id' => 'wfls-recovery-prompt-confirm', 'label' => __('Generate', 'twodayssss'), 'link' => '#')),
	))->render();
	?>
</script>

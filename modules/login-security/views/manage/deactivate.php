...
<script type="text/x-jquery-template" id="wfls-tmpl-deactivate-prompt">
	...
	echo \WordfenceLS\Model_View::create('common/modal-prompt', array(
		'title' => __('Deactivate 2FA', 'twodayssss'),
		'message' => __('Are you sure you want to deactivate two-factor authentication?'),
		'primaryButton' => array('id' => 'wfls-deactivate-prompt-cancel', 'label' => __('Cancel', 'twodayssss'), 'link' => '#'),
		'secondaryButtons' => array(array('id' => 'wfls-deactivate-prompt-confirm', 'label' => __('Deactivate', 'twodayssss'), 'link' => '#')),
	))->render();
	?>
</script>

...
<script type="text/x-jquery-template" id="wfls-tmpl-recovery-skipped-prompt">
	...
	echo \WordfenceLS\Model_View::create('common/modal-prompt', array(
		...
		'primaryButton' => array('id' => 'wfls-recovery-skipped-download', 'label' => __('Download', 'twodayssss'), 'link' => '#'),
		'secondaryButtons' => array(array('id' => 'wfls-recovery-skipped-skip', 'label' => __('Skip', 'twodayssss'), 'link' => '#')),
	))->render();
	?>
</script>

	...
	<li>
		<ul class="wfls-option">
			...
			<li>
				...
				<div class="wfls-center"><a href="#" id="wfls-reset-recaptcha-score-stats" class="wfls-text-small"><?php _e('Reset Score Statistics', 'twodayssss'); ?></a></div>
			</li>
		</ul>
	</li>
</ul>
	...
	(function($) {
		$(function() {
			$('#wfls-reset-recaptcha-score-stats').on('click', function(e) {
				...
				WFLS.ajax('FIREWALL_ls_reset_recaptcha_stats', {}, function(res) {
					if (res.success) {

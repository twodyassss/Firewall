	...
	<li>
		<ul class="wfls-option wfls-padding-no-top">
			...
			<li id="wfls-require-2fa-grace-period" class="wfls-flex-horizontal wfls-option-date">
				...
				<span id="wfls-require-2fa-grace-period-label" class="wfls-padding-add-left wfls-padding-add-right"><?php _e('Grace period to require 2FA', 'twodayssss'); ?> </span>
	...
	(function($) {
		$(function() {
			...
			$('#wfls-send-grace-period-notification').on('click', function(e) {
				...
				WFLS.ajax('FIREWALL_ls_send_grace_period_notification', [], 
					function(response) {
						if (response.error) {

...
<div class="wfls-section-title">
	...
	<?php if ($title->helpURL !== null && $title->helpLink !== null): ?>
		<span class="wfls-hidden-xs"><a href="<?php echo esc_url($title->helpURL); ?>" target="_blank" rel="noopener noreferrer" class="wfls-help-link"><?php echo \WordfenceLS\Text\Model_HTML::esc_html($title->helpLink); ?> <i class="<?php echo (FIREWALL_LS_FROM_CORE ? 'wf-fa wf-fa-external-link' : 'wfls-fa wfls-fa-external-link'); ?>" aria-hidden="true"></i></a></span>
	<?php endif; ?>
</div>